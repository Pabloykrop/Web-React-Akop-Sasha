...
const Customer = () => {
  return (
    <section className="bg-gray-100 flex gap-40 justify-center ">
      <div className='flex gap-40 justify-center mt-30 mb-30'>
        <div className="grid grid-cols-2 gap-8">
          {stats.map((item, i) => (
            <div key={i} className="bg-white w-64 h-72 rounded-xl text-center shadow-md flex flex-col items-center justify-center">
              <h1 className="text-indigo-600 text-6xl font-bold">{item.value}</h1>
